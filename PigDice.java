			...
			if ( ptot < 100 ) {
				...
				do {
					...
					if( roll == 1) {
						...
						// modified below so it doesn't say computer will roll again 
						// if it has 100 points
						if (turnTotal < 20 && (turnTotal + ctot + roll < 100) ) {
							System.out.println("\tComputer will roll again.");
						}
					}
				// modified here so computer doesn't keep rolling if it has 100 or more
				} while(roll != 1 && turnTotal < 20 && ( (roll + turnTotal + ctot) <= 100) );
